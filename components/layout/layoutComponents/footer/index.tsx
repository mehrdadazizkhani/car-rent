...
const Footer: React.FC<FooterProps> = (): JSX.Element => {
  return (
    <footer className="w-full bg-light-primary">
      <div className="mx-auto flex h-full max-w-[1440px] flex-col gap-12 py-8 px-6 lg:py-10 lg:px-[60px]">
        <div className="flex flex-col gap-12 lg:flex-row lg:justify-between">
          <div className="flex flex-col gap-4">
            ...
            <p className="w-72 text-xs lg:text-base">
              Our vision is to provide convenience and help increase your sales
              business.
            </p>
          </div>
          <div className="flex w-full flex-wrap justify-between gap-12 lg:w-fit lg:flex-nowrap">
            <div className="flex w-36 flex-col gap-6">
              <h3 className="text-xl font-semibold">About</h3>
              <ul className="flex flex-col gap-5 text-sm text-light-content md:text-base">
